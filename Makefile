...
OTHER_REPO_DOCS ?=  sdran-in-a-box onos-e2t onos-e2-sm onos-e2sub onos-api onos-ric-sdk-go onos-kpimon onos-config onos-topo onos-cli ran-simulator openairinterface5g
