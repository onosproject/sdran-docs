...
html_logo = '_static/sdran.svg'

html_favicon = '_static/sdran-favicon-128.png'
...
latex_documents = [
    (master_doc, 'SDRANDocs.tex', u'SD-RAN Docs',
     u'ONF', 'manual'),
]
...
man_pages = [
    (master_doc, 'SD-RAN Docs', u'SD-RAN Docs',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SD-RAN Docs', u'SD-Ran Docs',
     author, 'SD-RANDocs', 'One line description of project.',
     'Miscellaneous'),
]
...
linkcheck_ignore = [r'https://www.digikey.com',
                    ...
                    'https://github.com/onosproject/onos-a1t',
